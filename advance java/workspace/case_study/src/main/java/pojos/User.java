...
public class User {
	...
	// Generated Constructor for authenticate user POJO
	public User(int id, String firstName, String lastName, String email, String password, Date dob, boolean votingStatus,
			String role) {
		// TODO Auto-generated constructor stub
