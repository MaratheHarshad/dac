...
namespace MVCUsingEF.Controllers
{
    public class TblEmployeesController : Controller
    {
        private readonly EmployeesMvcdatabaseContext _context;

        public TblEmployeesController(EmployeesMvcdatabaseContext context)
        {
            _context = context;
        }
